...
func main() {
	...
	apiRouter.Post("/api/logout", &LogoutHandler{SessionStore: sessionStore, SecureCookie: secureCookie})
	apiRouter.Post("/api/disconnect", &DisconnectHandler{SessionStore: sessionStore, DBStore: dbStore, SecureCookie: secureCookie})
